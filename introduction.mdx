...
<Columns cols={2}>
  ...
  <Card title="For creators" icon="users">
    Upload your videos, see impressions, clicks and earnings for your own work, and cash out to your own Stripe account.
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="Plans and limits" icon="credit-card" href="/plans" horizontal>
    What each tier costs, what it allows, and what happens at a limit.
  </Card>
  ...
  <Card title="For creators" icon="users" href="/for-creators" horizontal>
    The whole product from the creator's side, including getting paid.
  </Card>
