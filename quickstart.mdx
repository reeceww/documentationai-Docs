...
<Steps>
  ...
  In **Hub**, then **Creatives**, the creator uploads a video. Files up to 500 MB, in the formats listed in [How do I upload content](/help-center/faq/how-to-upload-ugc).

  If you posted a [brief](/briefs), their submission attaches to it, which is what makes "three of the five we asked for have arrived" answerable.
...
<Columns cols={2}>
  <Card title="Hub" icon="layout-grid" href="/hub">
    Briefs, creative review, gifting, documents, boards, ad research and intelligence.
  </Card>
