...
<Steps>
  ...
  The workspace stays locked until a plan is chosen. Pick the tier that matches how many creators and team members you need.
...
<Steps>
  ...
  In **Hub**, the creator uploads a video against your brief. Files up to 500 MB, in the formats listed in [How do I upload content](/help-center/faq/how-to-upload-ugc).
...
<Columns cols={2}>
  <Card title="Hub" icon="layout-grid">
    Content review, boards, pages and gifting.
  </Card>
  ...
  <Card title="People" icon="users">
    Your roster, each creator's terms, and what their videos have earned.
  </Card>
